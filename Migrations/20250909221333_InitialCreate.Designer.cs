...
namespace AzureAPI.Migrations
{
    ...
    [Migration("20250909221333_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AzureAPI.Objects.Fight", b =>
                {
                    b.HasOne("AzureAPI.Objects.Fighter", "BlueCornerFighter")
                        .WithMany()
                    ...
                    b.HasOne("AzureAPI.Objects.Fighter", "RedCornerFighter")
                        .WithMany()
                        .HasForeignKey("RedCornerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("BlueCornerFighter");

                    b.Navigation("RedCornerFighter");
                });
